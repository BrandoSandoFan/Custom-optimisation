...
SpecTune's recommendation for the machine. No mixin: it swaps the screen the moment Fabric's
`ScreenEvents.BEFORE_INIT` fires for it, before vanilla ever builds a widget.
